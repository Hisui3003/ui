...
@include('layout.ownerheader')
    ...
    <div class="container p6 bg-white">
        <div class="container grid grid-cols-2 space-x-5 space-y-5 ml-5 pl-10">
        ...
        {{-- Submit Button --}}
        <div class="container mx-auto p-6 bg-white rounded-md pb-10 my-10">
            <button type="submit" class="bg-gray-700 h-24 hover:bg-red-500 border hover:border-red-500 text-white hover:text-white font-bold py-2 px-4 rounded-md w-full">
                Create Contract
            </button>
        </div>
    </div>
