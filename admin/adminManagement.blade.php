        ...
        {{-- manage wrapper --}}
            <div class="container p-6 ">
                ...
                <div class="grid grid-cols-5 gap-4">
                    ...
                    <div class="col-span-5 bg-white rounded-lg shadow-sm">
                        ...
                        {{-- renters list --}}
                        <div class="px-4 pb-2 overflow-hidden my-3 mt-20 rounded-2xl hover:scale-105 hover:shadow-2xl transition">
                         <div class="px-4 pb-2 bg-white rounded-2xl overflow-hidden">
                                <div class="mr-14 flex items-center">
                                    <h3 class="text-xl mt-5 font-semibold">
                                        Renters
